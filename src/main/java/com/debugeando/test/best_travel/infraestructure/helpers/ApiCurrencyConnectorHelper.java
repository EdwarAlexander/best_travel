...
import com.debugeando.test.best_travel.infraestructure.dtos.CurrencyDTO;
...
public class ApiCurrencyConnectorHelper {
    ...
    public ApiCurrencyConnectorHelper(@Qualifier(value = "base") WebClient currencyWebClient) {
